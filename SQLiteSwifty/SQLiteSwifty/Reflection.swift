...
fileprivate struct Property {
    ...
    struct Description {
        ...
        func write(_ value: Any,
                   to storage: UnsafeMutableRawPointer) throws {
...
func withClassValuePointer<Value, Result>(of value: inout Value,
...
class Reflection {
    ...
    class func set<T: SQLiteCodable>(_ value: Any,
                                     key: String,
                                     for instance: inout T) {
...
extension AnyExtensions {
    static func write(_ value: Any,
                      to storage: UnsafeMutableRawPointer) {
