...
extension SQLite.Connection {
    ...
    public func delete<Object: SQLiteCodable>(_ obj: Object) throws -> Int {
        ...
        guard let pk = map.pk else {
            throw SQLite.ErrorType.notSupportedError("Could not delete row without primary key")
        }
    ...
    @discardableResult
    public func delete<Object: SQLiteCodable>(using predicate: NSPredicate,
                                              on table: Object.Type) throws -> Int {
    ...
    @discardableResult
    fileprivate func deleteAll(map: SQLite.TableMapping) throws -> Int {
